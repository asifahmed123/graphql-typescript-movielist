      ...
      <div className="card bg-pink-600 text-primary-content">
        ...
        <div className="card-body p-5">
          ...
          <div className="flex gap-2 mt-2">
            <button className="btn btn-sm btn-secondary" onClick={handleAddToWatch}>Watch List</button>

            <button className="btn btn-sm btn-info" onClick={handleAddToWatchedList}>Watched</button>
          </div>
        </div>
      </div>
    </div>
